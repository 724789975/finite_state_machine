...
namespace BitSet
{
	...
	public:
		...
		virtual int						GetMutexBitMax() const = 0;
		virtual int						GetCompatibleBitMax() const = 0;
...
{\
	...
	public:\
		...
		int GetMutexBitMax() const\
		{\
			return E##EnumName##MutexBitEnd;\
		}\
		int GetCompatibleBitMax() const\
		{\
			return E##EnumName##CompatibleBitEnd;\
		}\
	private:\
...
#define EnumMutexBitEnd(EnumName)\
E##EnumName##MutexBitEnd,

#define EnumCompatibleBitEnd(EnumName)\
E##EnumName##CompatibleBitEnd,
